...
#define TRIS_LCD_E      TRISD
#define LAT_LCD_E       LATD
#define LCD_E           2
#define TRIS_LCD_RS     TRISD
#define LAT_LCD_RS      LATD
#define LCD_RS          0

/* Definición de las instrucciones principales de la pantalla LCD*/
