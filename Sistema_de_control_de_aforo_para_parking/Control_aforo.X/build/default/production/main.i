...
uint16_t Obtener_Distancia_Aum (void);
uint16_t Obtener_Distancia_Des (void);
...
void main(void)
{
    ...
    while(1)
    {
        Distancia_aum=Obtener_Distancia_Aum();
        Distancia_des=Obtener_Distancia_Des();
        if(Distancia_aum<50) {
            if(aforo<recibido) {
                aforo++;
                LATCbits.LATC0=0;
